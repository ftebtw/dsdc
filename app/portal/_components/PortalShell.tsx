...
export default function PortalShell({
  ...
  function onLocaleChange(nextLocale: "en" | "zh") {
    ...
    // Instant optimistic update - client components using useI18n() switch immediately.
    setOptimisticLocale(nextLocale);
    setI18nLocale(nextLocale);
    setLocaleUpdating(true);
    localeUpdatingRef.current = true;

    // Await the DB write then refresh so server components read the new locale.
      ...
      return [
        {
          ...
          items: [
            ...
            { href: "/portal/coach/feedback", label: t("portal.nav.coach.feedback", "Feedback"), icon: MessageSquare },
      ...
      return [
        {
          ...
          items: [
            ...
            { href: "/portal/student/homework", label: t("portal.nav.student.homework", "Homework"), icon: FileText },
            { href: "/portal/student/feedback-requests", label: t("portal.nav.student.feedbackRequests", "Feedback"), icon: MessageSquare },
        ...
        },
        {
          ...
          items: [
            ...
            { href: "/portal/student/feedback", label: t("portal.nav.student.feedback", "Anonymous Feedback"), icon: MessageSquare },
      ...
      return [
        {
          ...
          items: [
            ...
            { href: "/portal/parent/feedback-requests", label: t("portal.nav.parent.feedbackRequests", "Feedback"), icon: MessageSquare },
          ],
        },
        {
