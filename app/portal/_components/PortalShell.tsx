      ...
      return [
        {
          ...
          items: [
            ...
            { href: "/portal/student/feedback-requests", label: t("portal.nav.student.feedbackRequests", "Request Feedback"), icon: MessageSquare },
      ...
      return [
        {
          ...
          items: [
            ...
            { href: "/portal/parent/feedback-requests", label: t("portal.nav.parent.feedbackRequests", "Request Feedback"), icon: MessageSquare },
          ],
        },
        {
