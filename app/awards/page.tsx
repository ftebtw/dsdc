  ...
  return (
    <div className="bg-white rounded-xl border border-warm-200 p-5 hover:shadow-lg transition-all duration-300">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-lg font-bold text-navy-800 font-serif">{student.name}</h3>
      </div>
        ...
        {shown.map((award, i) => (
          <li key={i} className="flex items-start gap-2 text-sm font-sans">
            ...
            <span className="text-charcoal/60">
              {award.tournament} <span className="text-charcoal/40">({award.year})</span>
            </span>
          </li>
        ))}
      </ul>
      {student.awards.length > 3 && (
        <button
          ...
          className="flex items-center gap-1 mt-3 text-xs font-semibold text-navy-700 hover:text-gold-500 transition-colors"
        >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {round.awards.map((award, j) => (
                      <div key={j} className="flex items-start gap-2 text-sm font-sans">
                        ...
                        <span className="text-charcoal/70">{award}</span>
                      </div>
                    ))}
                  </div>
                </div>
